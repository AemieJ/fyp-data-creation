...
// World news daily report - feminine hygiene [no publishing dates - fill n/a [imputation]]
...
async function extractPostDetails() {
    const URL = 'https://worldnewsdailyreport.com/category/feminine-hygiene-2/';
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
